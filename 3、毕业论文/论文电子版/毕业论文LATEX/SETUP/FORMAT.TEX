...
\allowdisplaybreaks[4]                         %  \eqnarray 如果很长，影响分栏、换行和分页，% 可以设置成为自动调整模式
%===========================================================================
...
%------------------------------------------------------------------------------------------------------
\newcommand{\linghao}{\fontsize{48pt}{60pt}\selectfont}      % 零号, 1.4 倍行距
...
\newcommand{\yihao}{\fontsize{28pt}{38pt}\selectfont}        % 一号, 1.4 倍行距
\newcommand{\erhao}{\fontsize{21pt}{28pt}\selectfont}        % 二号, 1.25 倍行距
...
\newcommand{\xiaosihao}{\fontsize{12pt}{18pt}\selectfont}    % 小四, 1.5 倍行距
...
\newtheorem{character}{\indent 性质}[chapter]

\newtheorem{exam}{\indent\hei \color{black} 算例}[chapter]
\newtheorem{example}{\hspace{2em}\hei\color{white}Matlab 程序}[chapter]
\newcommand{\program}[1]{\noindent\parbox{14.6cm}{\includegraphics[width=3.1cm]{fig/sjwt.jpg}
\vspace{-1.12cm}\example\textcolor{black}{\hei#1}}\vspace{0.0cm}}  % 实际问题标志
...
\newtheorem{Solution}{\indent\hei \textcolor{black}{解}}

%==========程序框====================================
\newcommand{\programbox}[2]{
\begin{tcolorbox}[colback=white,colframe=white,title=\example #1]
 #2
\end{tcolorbox}}
%==========程序框结束====================================
...
\begin{colorboxed}[boxcolor=white,bgcolor=white]
\vspace{-0.3cm}\proposition #1
\end{colorboxed}}
%==========命题框结束====================================

%==========引理框====================================
\newcommand{\lemmabox}[1]{\vspace{0.1cm}
\begin{colorboxed}[boxcolor=white,bgcolor=white]
\vspace{-0.2cm}\lemma #1
\end{colorboxed}}
%==========引理框结束====================================

%==========定理框====================================
\newcommand{\theorebox}[2]{\vspace{0.1cm}
\begin{colorboxed}[boxcolor=white,fgcolor=black,bgcolor=white]
\vspace{-0.3cm}
\theorem\hei\color{black}#1
\vspace{0.35cm}
\end{colorboxed}
\vspace{-0.99cm} \setlength{\fboxsep}{0pt}
\begin{colorboxed}[boxcolor=white,fgcolor=black,bgcolor=white]#2
\vspace{-0.65cm}
...
%==========定义框====================================
\newcommand{\definibox}[2]{\vspace{0.1cm}
\begin{colorboxed}[boxcolor=white,fgcolor=black,bgcolor=white]
\vspace{-0.3cm}
\definition\hei\color{black}#1
\vspace{0.25cm}
\end{colorboxed}
\vspace{-0.9cm} \setlength{\fboxsep}{0pt}
\begin{colorboxed}[boxcolor=white,fgcolor=black,bgcolor=white]#2
\vspace{-0.7cm}
\end{colorboxed}\color{black}}
%==========定义框结束====================================
...
\CJKtilde \CJKindent
\setlength{\parindent}{2.05em}    %首行缩进2个汉字
%===========================定义段落章节的标题和目录项的格式======================
\setcounter{secnumdepth}{4}
\setcounter{tocdepth}{4}
\renewcommand\contentsname{目~~录}
\renewcommand\chaptername{\CJKprechaptername\CJKthechapter\CJKchaptername}
\titleformat{\chapter}[hang]{\filcenter\hei\sf}{\sanhao{\color{black}\chaptername}}{18pt}{\sanhao}
\titlespacing{\chapter}{0pt}{-12pt}{18pt}                                          % 标题左边距，上文距，下文距
\titleformat{\section}[hang]{\hei \sf \sihao\color{black}}{\sihao\color{black}\thesection}{0.5em}{}{}
\titlespacing{\section}{0pt}{-1pt}{10pt}         % 标题左边距，上文距，下文距
\titleformat{\subsection}[hang]{\hei \sf \xiaosihao\color{black}}{\xiaosihao \color{black}\thesubsection}{0.5em}{}{}
\titlespacing{\subsection} {0pt}{-2pt}{5pt}   % 标题左边距，上文距，下文距
...
%===========================目录点的设置======================
\dottedcontents{chapter}[0em]{\addvspace{0.8em}\hei\color{black}}{4em}{5pt}
...
\titlecontents{chapter}[0em]{\hei\color{black}}{\contentslabel{0em}}{\hspace*{0em}}{\dotfill \contentspage}% 定义章标题蓝色
...
\fancyhf{} %清空页眉
\lhead{\song\xiaowuhao 西北工业大学硕士学位论文}   % 左页眉
\rhead{\song\xiaowuhao\leftmark}   %右页眉显示章标题
\fancypagestyle{plain}{\pagestyle{fancy}}       % 所有页面加页眉
%在 book文件类别下,\leftmark自动存录各章之章名,\rightmark 记录节标题
...
%\fancyhead[RO]{\song\footnotesize\rightmark}  % 奇数页码中间显示节标题
%\fancyhead[RE]{\song\footnotesize\leftmark}  % 偶数页码中间显示章标题
...
%==========================设置行距和段落间垂直距离===============
\setlength{\parskip}{0.25pt plus1pt minus1pt}      % 段落之间的竖直距离
...
\newcounter{RomanNumber} %大写罗马数字编号
\newcommand{\MyRoman}[1]{\setcounter{RomanNumber}{#1}\Roman{RomanNumber}}
\let\orig@Description =\description
\def\Myspacing{\itemsep=0.5ex \topsep=-0.5ex \partopsep=0pt \parskip=0pt \parsep=0.5ex}
\def\newitemsep{
...
\renewcommand{\arraystretch}{1.25}   %表格内行间距
...
\hypersetup{colorlinks=true,linkcolor=black,anchorcolor=black,citecolor=black}%改变上标颜色
...
%=========================================================
\renewcommand{\captionlabeldelim}{\hspace{0.5em}}                  %  去掉图表号后面的:
\renewcommand{\captionfont}{\footnotesize}          %  图表标题字体为10pt, 这里写作小五号
%\renewcommand{\captionfont}{\wuhao}          %  图表标题字体为10pt, 这里写作五号
...
\def\makecover{
    \begin{titlepage}
    \begin{flushleft}
    \parbox[t][-1cm][c]{\textwidth}{ {\wuhao\song\@ctitle} }
    \end{flushleft}
    \begin{center}
    \parbox[t][5cm][c]{\textwidth}{\begin{center} {\sihao\song\@cftitle}\end{center}  }
    \parbox[t][4cm][c]{\textwidth}{\begin{center} {\erhao\fs\@cauthor}\end{center} }
    %\parbox[t][-5cm][c]{\textwidth}{ {\sanhao\@cauthor} }
    \parbox[t][12.0cm][b]{\textwidth}{\begin{center} {\song\sanhao\@publisher} \end{center} }
    \end{center}
    \end{titlepage}
    \normalsize
   }
