%------------------------------------------------引用的宏包和相应的定义-----------------------------------------
\usepackage{CJK,CJKnumb}          % 中文支持宏包
%\usepackage[paperwidth=207mm,paperheight=290mm,textheight=234mm,textwidth=151mm,left=28mm,right=28mm, top=28mm, bottom=28mm]{geometry}
\usepackage[paperwidth=207mm,paperheight=290mm,left=25mm,right=25mm,top=25mm, bottom=28mm,headheight=1.5cm,footskip=1.5cm]{geometry}                % 定义版面
%\usepackage[left=2.5cm,right=2.5cm,bottom=2.5cm,top=2.5cm,headheight=1.5cm,footskip=1cm]{geometry}
...
%\usepackage{picinpar}                  %图文混排(文包图)  picins 在前,picinpar在后,否则有问题
